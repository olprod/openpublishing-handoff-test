...
layout: HubPage
---
# Microsoft Enterprise Mobility-Dokumentation
<article id="main">
    <section id="hero-content" class="graph">
        <h1>Microsoft Enterprise Mobility-Dokumentation</h1>
        <h2>Microsoft & #39; s Enterprise Mobility Services können Organisationen ihre Mitarbeiter produktiv über apps und Geräte beim beibehalten sicherstellen, dass Unternehmensdaten geschützt sind</h2>
        <!-- <ol id="actions" class="action-list">
        <li><a href="" class="button button-bordered">Learn More</a></li>
        </ol> -->
        <h3>Neu in Enterprise-Mobilität? <a href="https://www.microsoft.com/en-us/server-cloud/enterprise-mobility/overview.aspx" target="_blank">Besuchen Sie die Enterprise Mobility-Seite &rarr;</a></h3>
    </section>
